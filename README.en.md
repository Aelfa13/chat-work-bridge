...
[![Pre-release v1.0.0-rc.2](https://img.shields.io/badge/pre--release-v1.0.0--rc.2-blue)](https://github.com/wudy29/engineering-bridge/releases/tag/v1.0.0-rc.2)
...
[简体中文](README.md) · **[v1.0.0-rc.2](https://github.com/wudy29/engineering-bridge/releases/tag/v1.0.0-rc.2) · V1 Release Candidate / Pre-release · Local · Continuously maintainer-tested on macOS.** This is the V1 Release Candidate (`v1.0.0-rc.2`), not stable `v1.0.0`, and it does not indicate npm publication. Early/community Windows users have completed the read-only, patch-generation, `APPLY`, and real-write flow; `v1.0.0-rc.2` still needs external Windows and multi-client validation, and this is not maintainer-certified Windows compatibility.
...
The V1 RC (`v1.0.0-rc.2`) has no one-click installer.
